...
jQuery(document).on('ready', function() {
	...
	/* -------------------------------------
			POPULAR tOUR SLIDER
	-------------------------------------- */
	var _tg_populartoursslider = jQuery('#tg-populartourssliderone');
	_tg_populartoursslider.owlCarousel({
		loop: true,
		dots: false,
		nav: true,
	...
	/* -------------------------------------
			POPULAR tOUR SLIDER
	-------------------------------------- */
	var _tg_populartoursslider = jQuery('#tg-populartoursslidertwo');
	_tg_populartoursslider.owlCarousel({
		loop: true,
		dots: false,
		nav: true,
	...
	/* -------------------------------------
			POPULAR tOUR SLIDER
	-------------------------------------- */
	var _tg_populartoursslider = jQuery('#tg-experiences');
	_tg_populartoursslider.owlCarousel({
		loop: true,
		dots: false,
		nav: true,
	...
	/* -------------------------------------
			POPULAR tOUR SLIDER
	-------------------------------------- */
	var _tg_populartoursslider = jQuery('#tg-populartourssliderfooter');
	_tg_populartoursslider.owlCarousel({
		loop: true,
		dots: false,
		nav: true,
